...
setup(
    ...
    version=get_version('Transilen_Domoticz/__init__.py'),

    description='A Python script for use transilien.com API with Domoticz.',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/matleses/Transilien-Domoticz',
